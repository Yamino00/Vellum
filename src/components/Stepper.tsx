          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            <div className={`mt-10 flex ${currentStep !== 1 ? 'justify-between' : 'justify-end'}`}>
              ...
              <button
                ...
                className="duration-350 flex items-center justify-center rounded-full bg-blue-600 py-1.5 px-3.5 font-medium tracking-tight text-white transition hover:bg-blue-700 active:bg-blue-800"
                {...nextButtonProps}
              >
                {isLastStep ? 'Completa' : nextButtonText}
              </button>
            </div>
          </div>
        )}
