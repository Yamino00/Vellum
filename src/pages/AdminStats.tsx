      ...
      <div className="w-full px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-3xl font-bold text-violet-600">{stats.totalBooks}</p>
          </div>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  ...
                  dataKey="count"
                >
                  {stats.loansByGender.map((entry, index) => (
                    <Cell 
                      key={`cell-${index}`} 
                      fill={entry.genere === 'F' ? '#EC4899' : COLORS[index % COLORS.length]} 
                    />
                  ))}
                </Pie>
                <Tooltip />
